...
export class REI extends ethereum.SmartContract {
  static bind(address: Address): REI {
    return new REI("REI", address);
  }
  ...
  mint(msgSender: Address, to: Address, tokenURI_: string): BigInt {
    let result = super.call("mint", "mint(address,address,string):(uint256)", [
